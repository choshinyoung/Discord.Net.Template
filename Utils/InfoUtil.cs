...
public static class InfoUtil
{
    ...
    public static T GetPrecondition<T>(CommandInfo info)
    ...
    public static T GetPrecondition<T>(ModuleInfo info)
        where T : PreconditionAttribute
    {
        return (T)info.Preconditions.First(p => p.GetType() == typeof(T));
    }
    ...
    public static T GetAttribute<T>(CommandInfo info)
        where T : Attribute
    {
    ...
    public static T GetAttribute<T>(ModuleInfo info)
        where T : Attribute
    {
        return (T)info.Attributes.First(p => p.GetType() == typeof(T));
    }
    ...
    public static T GetPrecondition<T>(SlashCommandInfo info)
    ...
    public static T GetAttribute<T>(SlashCommandInfo info)
        where T : Attribute
    {
        return (T)info.Attributes.First(p => p.GetType() == typeof(T));
    }
    ...
    public static T GetAttribute<T>(Discord.Interactions.ModuleInfo info)
        where T : Attribute
    {
        return (T)info.Attributes.First(p => p.GetType() == typeof(T));
    }
